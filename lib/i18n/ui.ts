...
export function getRadialBlockMenuCopy(language: AppLanguage) {
    return language === "es"
        ? {
            ...
            blockNamePlaceholder: "Escribi el nombre del bloque",
            planningMetadata: "Metadatos de planificacion",
            importance: "Importancia",
            importanceHigh: "Alta",
            importanceMedium: "Media",
            importanceLow: "Baja",
            importanceHint: "Le marca al sistema cuanto pesa este bloque.",
            flexibilityLabel: "Se puede mover?",
            flexibilityHint: "Apagado se trata como un bloque fijo.",
            intensityLight: "Liviano",
            intensityMedium: "Medio",
            intensityHigh: "Intenso",
            flexibilityFixed: "No",
            flexibilityModerate: "Un poco",
            flexibilityFlexible: "Si",
            splittableYes: "Se puede dividir",
            splittableNo: "Mantener entero",
            optionalYes: "Puede omitirse",
            optionalNo: "Es indispensable",
            splittableHint: "Permite repartirlo en mas de una parte.",
            requiredLabel: "Es indispensable",
            requiredHint: "Encendido significa que no conviene saltarlo.",
            recurrence: "Repeticion",
            ...
            showMoreOptions: "Mas opciones",
            hideMoreOptions: "Menos opciones",
            howToTreatBlock: "Como tratar este bloque",
            advancedHint: "Solo lo justo para que Agendo lo acomode mejor.",
            today: "Hoy",
            tomorrow: "Manana",
        ...
        : {
            ...
            blockNamePlaceholder: "Write the block name",
            planningMetadata: "Planning metadata",
            importance: "Importance",
            importanceHigh: "High",
            importanceMedium: "Medium",
            importanceLow: "Low",
            importanceHint: "Tells the system how much this block matters.",
            flexibilityLabel: "Can this move?",
            flexibilityHint: "When off, the block is treated as fixed.",
            intensityLight: "Light",
            intensityMedium: "Medium",
            intensityHigh: "Intense",
            flexibilityFixed: "No",
            flexibilityModerate: "A little",
            flexibilityFlexible: "Yes",
            splittableYes: "Can be split",
            splittableNo: "Keep together",
            optionalYes: "Can be skipped",
            optionalNo: "Essential",
            splittableHint: "Allows the block to be split into parts.",
            requiredLabel: "Essential",
            requiredHint: "When on, Agendo treats it as non-skippable.",
            recurrence: "Recurrence",
            ...
            duration: "Duration",
            editSchedule: "Adjust schedule",
            showMoreOptions: "More options",
            hideMoreOptions: "Fewer options",
            howToTreatBlock: "How to treat this block",
            advancedHint: "Only the signals Agendo needs to place it well.",
            today: "Today",
            tomorrow: "Tomorrow",
